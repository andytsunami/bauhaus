...
GameCtrl.Stage01.prototype = {
    ...
    create: function () {
        ...
        //this.background = this.game.add.tileSprite(0, 200, 1024, 552, 'stage01');
        this.background = this.game.add.tileSprite(0, 200, 8192, 552, "stage01");
