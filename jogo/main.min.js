...
function() {
    GameCtrl.MainMenu = function() {
        ...
        create: function() {
            ...
            this.startText = this.game.add.text(this.game.width / 2 - 180, this.game.height / 2 + 120, "Aperte Enter\n para começar", c), this.game.physics.startSystem(Phaser.Physics.ARCADE);
